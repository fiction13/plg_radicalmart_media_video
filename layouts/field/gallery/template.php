...
if (!$template)
{
	return LayoutHelper::render('plugins.radicalmart_media.video.field.gallery.item', $displayData);
}
...
<div class="col col-md-6 col-lg-3 mb-3" radicalmart-field-gallery="item"
	...
	<div class="card">
		<div class="preview border border-bottom-0 bg-light d-flex align-items-center justify-content-center p-2 text-center"
			 style="height: 250px;">
			<video radicalmart-field-gallery="preview" class="mw-100 mh-100 object-fit-contain" src="" autoplay loop muted></video>
		</div>
		<div class="card-text">
